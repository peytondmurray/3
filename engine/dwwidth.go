...
var (
	...
	DWHalfWidth = 5 //5 is usually a safe number. If you increase this, you get better domain wall fits but fitting will fail if Mz >= 1 (which can happen due to numerical error), which gets more likely the futher away from the domain wall you are.
)
